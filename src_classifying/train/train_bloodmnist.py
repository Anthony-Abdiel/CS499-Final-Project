...
CHECKPOINT_PATH = os.path.join(
    CHECKPOINT_DIR,
    "bloodmnist_lightweight_cnn_normal_best.pt"
)
...
train_dataset = BloodMNISTDataset(DATA_PATH, split="train")
val_dataset = BloodMNISTDataset(DATA_PATH, split="val")
test_dataset = BloodMNISTDataset(DATA_PATH, split="test")
