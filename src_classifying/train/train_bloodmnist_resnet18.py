...
CHECKPOINT_PATH = os.path.join(
    CHECKPOINT_DIR,
    "bloodmnist_resnet18_normal_best.pt"
)
...
# Resize BloodMNIST images from 28x28 -> 224x224 for ResNet
...
model = ResNet18Classifier(num_classes=8, pretrained=True).to(device)
